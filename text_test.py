...
def test():
    ...
    t1=time.time()
    x_test,y_test,x_train_topic=process_file(config.test_w2v_data,word_to_id,cat_to_id,config.seq_length)
    ...
    feed_dict = {
        ...
        model.keep_prob:1,
        model.x_train_topic:pre_trianing_LDAtest,
        model.flag:False
        }
...
if __name__ == '__main__':
    ...
    pre_trianing_LDAtest = get_training_LDA_vectors(config.pre_trianing_LDAtest)
